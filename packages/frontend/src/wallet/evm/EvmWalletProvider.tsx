 ...
 *
 * Mount this inside `<WalletGateProvider>` in `main.tsx`, above
 * `<StellarWalletProvider>` and `<RouterProvider>`.
 *
 ...
 *
 * The first-connection terms gate (`WalletGateProvider`) is now hoisted above
 * both wallet providers and is no longer owned by this component.
 */
