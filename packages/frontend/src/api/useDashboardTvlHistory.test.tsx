...
import type { TvlHistoryResponse } from "./useDashboardTvlHistory";
...
const FIXTURE_WITH_DATA: TvlHistoryResponse = {
  series: [
...
const FIXTURE_EMPTY: TvlHistoryResponse = {
  series: [],
  max: "0.000000",
  min: "0.000000",
  average: "0.000000",
...
describe("useDashboardTvlHistory — mock-key path", () => {
  ...
  it("returns fixture data immediately from mock key, never calls fetch", async () => {
    ...
    const { result } = renderHook(
      () => useDashboardTvlHistory({ chainId: 560048 }),
      { wrapper: makeWrapper() },
    );
