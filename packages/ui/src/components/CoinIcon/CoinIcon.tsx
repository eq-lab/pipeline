...
/**
 * CoinIcon — displays a USDC or PLUS-D coin icon at a given size.
 *
 * The icons are the blue coin SVGs introduced in issue #100.  Both assets
...
export const CoinIcon = React.forwardRef<SVGSVGElement, CoinIconProps>(
  function CoinIcon(
    ...
    const b64 = token === "usdc" ? USDC_B64 : PLUSD_B64;
