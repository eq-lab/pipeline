 ...
 *
 * Ported into `@pipeline/wallet-connect` (#791 shared-slice extraction) so
 * both the LP frontend and the Trustee app render the identical picker.
 *
 ...
 *
 * Entry point: called from TopBar (replaces ConnectChooserModal) in the LP
 * app; called from the Trustee sign-in flow (#791) in the Trustee app.
 *
...
import { useEvmConnectors } from "./evm/useEvmWallet";
import type { EvmWalletConnectorId } from "./evm/useEvmWallet";
import { useStellarConnectors } from "./stellar/useStellarWallet";
