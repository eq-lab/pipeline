  ...
  test: {
    ...
    server: {
      deps: {
        ...
        // bundle to ESM with named-export compatibility. Mirrors
        // packages/frontend/vite.config.ts — needed here now that the
        // network switcher (issue #1032) exercises the real
        // `@pipeline/wallet-connect` barrel (not fully mocked) in tests.
