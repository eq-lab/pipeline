...
| [#603 Stellar deposit/withdraw flow doesn't surface an unreachable/unconfigured DepositManager banner](https://github.com/eq-lab/pipeline/issues/603)                          | [603-stellar-manager-unreachable-banner.md](./epic-498/603-stellar-manager-unreachable-banner.md)     | Initial |
