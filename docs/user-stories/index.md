...
| Issue                                                                                                                                                                    | Doc                                                                                                   | Status  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------- | ------- |
| [#718 Panel A: Balance Sheet UI](https://github.com/eq-lab/pipeline/issues/718)                                                                                          | [718-balance-sheet-panel.md](./epic-712/718-balance-sheet-panel.md)                                   | Initial |
...
| [#726 Loan Book panel: tabs render above summary cards; Figma places cards under heading and tabs inside table container](https://github.com/eq-lab/pipeline/issues/726) | [726-loan-book-section-order.md](./epic-712/726-loan-book-section-order.md)                           | Initial |
| [#727 Loan Book panel — tab labels missing count badges + tab restyle to Figma](https://github.com/eq-lab/pipeline/issues/727)                                           | [727-loan-book-tab-badges-styling.md](./epic-712/727-loan-book-tab-badges-styling.md)                 | Initial |
...
| [#814 Protocol Dashboard: In-Origination tab — display the Figma field set (frontend-only)](https://github.com/eq-lab/pipeline/issues/814)                              | [814-origination-figma-field-set.md](./epic-712/814-origination-figma-field-set.md)                   | Initial |
...
| [#813 Trustee: implement the Origination page (Figma 4116-9155)](https://github.com/eq-lab/pipeline/issues/813)                                         | [813-trustee-origination-page.md](./epic-775/813-trustee-origination-page.md) | Initial |
| [#818 Trustee Overview: Needs Attention block — Origination group (in-review submissions)](https://github.com/eq-lab/pipeline/issues/818)               | [818-needs-attention-origination.md](./epic-775/818-needs-attention-origination.md) | Initial |
| [#821 Trustee: Origination details page /origination/:id — Loan Terms + Deal Details (NO collateral valuation)](https://github.com/eq-lab/pipeline/issues/821) | [821-origination-details-page.md](./epic-775/821-origination-details-page.md) | Initial |
| [#823 Trustee Origination: row-click navigation + status-conditional detail footer (Approved/Rejected blocks)](https://github.com/eq-lab/pipeline/issues/823) | [823-origination-rowclick-status-footer.md](./epic-775/823-origination-rowclick-status-footer.md) | Initial |
| [#827 Origination table: show Originator name from loan_data instead of submitter address](https://github.com/eq-lab/pipeline/issues/827) | [827-originator-name-from-loan-data.md](./epic-775/827-originator-name-from-loan-data.md) | Initial |
| [#829 Trustee Origination: wire Approve/Reject submission review (reject-reason dialog + auth)](https://github.com/eq-lab/pipeline/issues/829) | [829-approve-reject-review-wiring.md](./epic-775/829-approve-reject-review-wiring.md) | Initial |
| [#831 Trustee: on-chain draw_loan mint on approval (Option B — trustee wallet-signed)](https://github.com/eq-lab/pipeline/issues/831) | [831-onchain-draw-loan-mint.md](./epic-775/831-onchain-draw-loan-mint.md) | Initial |
| [#838 Trustee Origination: update Approve-mint & Reject dialogs to Figma; drop footer note + Request changes](https://github.com/eq-lab/pipeline/issues/838) | [838-origination-dialogs-figma.md](./epic-775/838-origination-dialogs-figma.md) | Initial |
...
| Issue | Doc | Status |
| --- | --- | --- |
| [#1248 KYB: Sign-in modal (email + password)](https://github.com/eq-lab/pipeline/issues/1248) | [1248-kyb-signin-modal.md](./epic-1247/1248-kyb-signin-modal.md) | Amended by #1265 |
| [#1249 KYB: Create-account modal](https://github.com/eq-lab/pipeline/issues/1249) | [1249-kyb-create-account.md](./epic-1247/1249-kyb-create-account.md) | Amended by #1281, #1265 |
| [#1250 KYB: OTP email-verification screen](https://github.com/eq-lab/pipeline/issues/1250) | [1250-kyb-otp.md](./epic-1247/1250-kyb-otp.md) | Amended by #1265 |
| [#1251 KYB: Company Docs upload step](https://github.com/eq-lab/pipeline/issues/1251) | [1251-kyb-company-docs.md](./epic-1247/1251-kyb-company-docs.md) | Superseded (V1.0 redesign 2026-09-22, #1278) |
| [#1252 KYB: Owners step](https://github.com/eq-lab/pipeline/issues/1252) | [1252-kyb-owners.md](./epic-1247/1252-kyb-owners.md) | Superseded (retired 2026-09-21, #1279) |
...
| [#1265 KYB: wire auth screens to backend auth](https://github.com/eq-lab/pipeline/issues/1265) | [1265-wire-kyb-auth.md](./epic-1247/1265-wire-kyb-auth.md) | Initial |
