...
All three wallets run on the same custody substrate under separate cosigner-policy configurations. A compromise at one does not propagate to the others.
