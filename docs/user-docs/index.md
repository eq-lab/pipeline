---
redirect_to: /start-here/faqs/
sitemap: false
---

<!--
The site root redirects to /start-here/faqs/. This page exists only to satisfy
the docs reachability lint (every doc must be linked from AGENTS.md or
transitively); the link list below is the sitemap.
-->
