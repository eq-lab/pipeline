...
<div class="callout info">
  <h4>Jurisdictional restrictions — pending</h4>
  <p>The list of jurisdictions excluded from the MVP offering is under legal review. It will be published here before launch. Until then, assume standard sanctions-list exclusions (OFAC and equivalent) apply.</p>
</div>
...
<div class="callout info">
  <h4>Terms of use — pending publication</h4>
  <p>The full Terms of Use will be published here before launch. Lenders must accept the terms before their first deposit.</p>
</div>
...
<div class="callout info">
  <h4>Privacy policy — pending publication</h4>
